...
exports.default = {
    authController: {
        handleRegisterErrorLog: '🚀 ~ file: auth.controller.ts ~ handleRegister ~ err',
        handleLoginErrorLog: '🚀 ~ file: auth.controller.ts ~ handleLogin ~ err',
        handleVerifySessionErrorLog: '🚀 ~ file: auth.controller.ts ~ handleVerifiySession ~ err',
    ...
    resumeController: {
        ...
        addProjectErrorLog: '🚀 ~ file: resume.controller.ts ~ addProject ~ err',
        deleteProjectErrorLog: '🚀 ~ file: resume.controller.ts ~ deleteProject ~ err',
