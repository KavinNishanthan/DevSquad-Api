...
const createDrive = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const { companyName, driveDate, requirements, rolesAndSalary, numberOfRounds, companyLocation, roundDetails, eligibleBatch, eligibleDepartments, eligibilityCriteria, techStackEligibility } = req.body;
        ...
        const driveValidationSchema = joi_1.default.object({
            ...
            techStackEligibility: joi_1.default.object({
                ...
                requiredSkills: joi_1.default.array().items(joi_1.default.string()).default([])
            }).required()
        });
